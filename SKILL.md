...
| Reference Authority (0-25) | Number of sources, URL validity, domain credibility, format correctness | 22+ |
...
1. Score each axis independently:
   ...
   - **Reference Authority**: Validate URLs (HEAD request), check domain credibility, verify format
...
2. For each axis below target:
   ...
   - **Reference Authority**: Add/replace references, validate URLs, fix formatting
